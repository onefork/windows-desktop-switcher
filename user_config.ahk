...
#F5::refreshWindowList(true) ; notifications on
#F11::saveWindowList(true, true) ; force refresh, notifications on
#F12::applyWindowList(false, true) ; no refresh, notifications on

; #F10::ShowActiveBrowserURL()
